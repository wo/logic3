...
\begin{exercise}
  ...
  is $T$ (a) computably axiomatizable? (b) decidable? (c) complete?
\end{exercise}
...
It follows that
\emph{there can be no true, computably axiomatizable, and complete theory in the language of arithmetic}.
